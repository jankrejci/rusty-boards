{
  description = "Voltage meter board";
  ...
  outputs = {
    ...
    in {
      checks = {
        ...
        # no_std/no_main targets that use build-std.
      ...
      devShells.default = pkgs.mkShell {
        ...
        shellHook = ''
          echo "ESP32-C3 voltage-meter dev environment ready"
          echo ""
          echo "  cd firmware"
